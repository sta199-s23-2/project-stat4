...
```{r}
#| label: Graph 2 between Housing units without vehicle count beyond 10 miles from supermarket and people living in housing quarters

food_access_reg |>
  filter(region == "Midwest" | region == "Northeast") |>
  ggplot(aes(x=`Vehicle Access.10 Miles`, y= group_quarters)) +
  geom_point() +
  labs(title="Scatterplot of vehicle access beyond 10 miles against population in group quarters", x="Vehicle Access.10 Mile", y="Population in group quarters")
