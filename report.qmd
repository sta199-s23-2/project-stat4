...
The true mean proportion of low income population count beyond 10 miles from the supermarket is .11 for the Midwest region and .017 for the Northeast region. $\bar{x_Midwest} = 0.1124311$ 
$\bar {x_Northeast} = .017$
