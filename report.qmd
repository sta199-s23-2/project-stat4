...
As for potential ethical concerns with data collection with the census, informed consent, impartiality, and transparency are some main ones. Individuals should be fully informed about the purpose of the census and how their data will be used and any lack of informed consent would lead to a violation of an individual’s privacy rights. As impartiality, census collection should be conducted in an impartial and unbiased manner.

These concerns, along with other concerns such as accuracy, undercounting, and sampling bias are important to acknowledge.
