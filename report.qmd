...
We will be using r functions to create graphs to analyze the data and find linear regression for different factors like using parent income, parent education, and wealth quintile. 
