...
food_access_reg |>
  ...
  labs(title = "Relationship between proportion of no vehicle access and \n being 10 miles away from supermarkets versus proportion of \n low-income individuals who are 10 miles away",
       x = "Proportion of no vehicle access being 10 miles \n away from supermarkets/ housing units",
       y = "Proportion of 10 miles away from supermarkets \n and low-income/ housing units")
...
food_access_reg |>
  ...
  geom_point() + 
  facet_wrap("region", ncol = 1) +
  labs(title = "Relationship between proportion of seniors and \n being 10 miles away from supermarkets versus proportion of \n low-income individuals who are 10 miles away",
       x = "Proportion of seniors being 10 miles away from supermarkets/ housing units",
       y = "Proportion of 10 miles away from \n supermarkets and low-income/ housing units")
...
food_access_reg_MID_and_NORTH |>
  ...
  geom_density() +
  labs(title = "Density of areas within the Midwest and Northeast \n who have vehicle access to a supermarket 10 miles away",
...
By quantifying and visualizing the relationship between the variables in the Midwest and Northeast, the sample mean difference is extracted from the given regions. This is used to run a hypothesis test in order to answer our research question because if the p-value is less than alpha, then we can reject the null hypoythesis. This would help answer our research question as it would show which region is impacted more by taking the mean of the proportions of low income people 10 miles away from the supermarket without a vehicle. Based on the results of the hypothesis test, we run a confidence interval in order to see where the true mean lies in each region.
...
The observed mean proportion difference between $\bar{x_{Midwest}}$ and $\bar{x_{Northeast}}$ = 0.09569124$
...
$p$ = low income individuals who are 10 miles away from supermarkets/  housing units
$p_v$ = no vehicle access beyond 10 miles from a supermarket population count/ housing units
$p_s$ = seniors beyond 10 miles from a supermarket population count/ housing units
...
Based on the exploratory data analysis, the first graph is a density plot that shows the distribution of vehicle access beyond 10 miles for both the Midwest and Northeast regions. The graph is relevant as it shows the difference in the distribution of vehicle access between the two regions. For instance, the Midwest region appears to have a higher density of vehicle access beyond 10 miles than the Northeast region. The third and fourth ROC graph curves represent where the x-axis represents the false positive rate, while the y-axis represents the true positive rate. The graph is relevant as it shows the ability of the logistic regression model to distinguish between the Midwest and Northeast regions based on vehicle access beyond 10 miles. For instance, the higher the AUC, the better the model is at discriminating between the two regions. They both have an AUC of around 0.717, indicating a high prediction rate based on the regions and no vehicle access. This helps quantify the strength of the relationships and set up for the hypothesis test.
...
might delete <- Interpretation: We are 95% confident that the true mean proportion of low income individuals that live beyond 10 miles from a supermarket in the Midwest is between 0.102609 and 0.1226445. (Other confidence)

add <- key takeaway from CIs

The two explanatory graphs in the Introduction support our claim that the Midwest is more impacted as the proportions for the Midwest reach higher numbers for the proportion of low income who are 10 miles away. Moreover, it shows that having no vehicle access contributes to this problem, supporting our claim that the Midwest is more impacted by not having reliable access to transportation compared to more urban areas like the Northeast.

Linear regression: After we rejected our null hypthesis, we created a linear regression to see which variables affect low income and being 10 miles away for the Midwest specifically. We found that the best model was when the proportion of seniors and proportion of no vehicle access being 10 miles away interacted with each other. This model had the highest adjusted r squared value (0.8715612). A higher r-squared value indicates a higher amount of variability being explained by our model. Therefore, our adjusted r-squared value supports that our interactive model is a good fit for our data. This value answers the second part of our research question. Individiuals who are a senior and have no vehicle access and being 10 miles beyond a supermarket contribute to low income and being 10 miles beyond a supermarket in the midwest. 
