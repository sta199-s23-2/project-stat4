...
food_access_reg |>
  ...
  labs(title = "Relationship between proportion of seniors and \n being 10 miles away from supermarkets versus proportion of \n low-income individuals who are 10 miles away",
       x = "Proportion of seniors being 10 miles away from supermarkets/ population",
       y = "Proportion of 10 miles away from \n supermarkets and low-income/ population")
...
Explanation for Density Curve: Given the population without vehicle access beyond 10 miles from a supermarket, the density curves for both regions have a similar shape, with the Midwest having a slightly higher density of lower values of vehicle access compared to the Northeast. There is some overlap between the two regions in terms of the distribution of vehicle access, indicating that there are some areas in the Midwest with similar vehicle access to supermarkets as some areas in the Northeast.
